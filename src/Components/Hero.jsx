import { BUSINESS, PHONE, TEL_HREF, reportCallConversion } from "../config";
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 mt-2">
          ...
          <a
            ...
            className="border border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-black font-bold text-base px-8 py-3.5 min-h-[48px] rounded-xl transition-all duration-200 flex items-center gap-2"
          >
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
